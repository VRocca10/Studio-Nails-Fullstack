...
export default function AdminLogin() {
  const { user, signInWithEmailPassword, testCredentials } = useAuth();
      ...
      <main style={{ width: "min(520px, 100%)", margin: "2rem auto", padding: "0 1rem" }}>
        <section className="section">
          ...
          <form onSubmit={handleSubmit} style={{ display: "grid", gap: "0.8rem", textAlign: "left" }}>
            ...
            <p style={{ margin: 0, fontSize: "0.9rem", color: "#566574" }}>
              Teste: {testCredentials.email} / {testCredentials.password}
            </p>
